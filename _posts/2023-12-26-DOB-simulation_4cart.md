...
<center>
  <img src='/images/Blog_img/DOB_post/DOB_4cart.jpg' width='500' height='300' />
...
<img src='/images/Blog_img/DOB_post/DOB_2cart_4cart_m4_1.2_tau_0.025.jpg' width='500' height='300' />
<img src='/images/Blog_img/DOB_post/DOB_2cart_4cart_m4_1.2_tau_0.01.jpg' width='500' height='300' />
...
The red line indicates the output y(position of the second cart) for the ideal case when the controller is applied to the nominal system(2-cart). The blue line indicates the output y of the true 4-cart system. You can see that the output y is well stabilized to the position y=1m.
