...
The goal of this control problem, is to make your system output **y** to follow the reference signal **r** under disturbance d(t) and (parametric) uncertainty in P(s).
