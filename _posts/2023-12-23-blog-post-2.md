...
<center>
  <img src='/images/Blog_img/DOB_post/DOB_relative.jpg' width='200' />
</center>
...
<center>
  <img src='/images/Blog_img/DOB_post/DOB_Controller.jpg' width='250' />
</center>
...
- $n-l=r$ number of roots approach to the roots of
  - $p_f(s) \coloneqq D_q^1(s) + (\frac{\beta_l}{\beta_{l',n}}-1)N_q(s)$
...
When designing the Q-filter for the DOB, it is crucial to ensure that both your Q-filter and controller meet the conditions mentioned above. If you are interested in the Q-filter design for DOB implementation, numberous research resources are available online. 
