...
1. Parametric Uncertainties:
  -Your model parameters, such as mass or length, might differ from your true system.
2. External Disturbances:
  -For instance, your UAV might be affected by the wind while flying
3. Unmodeled Dynamics:
  -Usually your model is designed using simplified dynamics(often linearized). The system's dynamics, such as those inside the motors or the elasticity of the beam, are often ignored, actually changes the system's degree.
