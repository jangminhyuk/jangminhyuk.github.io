...
- The card_video and card_image fields override the research record's inline MP4 and poster; card_* fields supply concise text. A research website field adds a project-site link to the research links and combined project card. Research figures use a contain layout so axes and legends remain visible.
